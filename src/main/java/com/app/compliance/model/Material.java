...
public class Material {
    ...
    public enum MaterialFamily{
        ABS,ADDITIVE,ADHESIVEPAPER,ADHESIVETAPE,ADHESIVE,ALUMINUM,BRASS,CARTONBOX,CIIR,COLORANT,COP,EVA,HDPE,HIPS,INK,IR,LDPE,MABS,MEDICALPAPER,MULTIMATERIAL,NA,NITINOL,PA,PAPE,PAPER,PC,PCABS,PE,PEEVA,PES,PET,PETPE,PETPP,PMMA,PO,POM,PP,PPPE,PPC,PPE,PPH,PS,PSU,PTFE,PUR,PVC,PVP,SAN,SBC,SEBS,SI,SOLVENT,SST,SUBSTANCES,SULFATE,TPE,TPU,TUNGSTEN
    }
