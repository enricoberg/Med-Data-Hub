...
public class Component {
    ...
    public enum ComponentFamily {
        FILMS,IFU,TRANSDUCERS,MATERIALS,CAPS,CONNECTORS,CONICALCONNECTORS,INJECTIONPOINTS,FILTERS,CLAMPS,SPIKES,CHAMBERS,COVERS,TUBES,VARIOUS,BAGS,CARTONS,POUCHES,ADJUVANTS,LABELS,SFTUBE,SFVARIOUS, ELECTRODES, HOTSTAMPING,INWORK,HARDWARE
    }
