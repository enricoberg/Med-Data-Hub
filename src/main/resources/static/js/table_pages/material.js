...
async function rendermaterials(){
    ...
    <div class="prevbutton hover-message" title="Previous Page" onclick="changePageMaterials(-1)"><img class="btnsmall" alt="Previous page" src="https://i.postimg.cc/zXN62Tk8/prev.png"></img></div>
        ...
        <div class="editbutton hover-message" title="Edit Selection" onclick="sendToEditMaterials()"><img class="btnsmall" alt="Edit selection" src="https://i.postimg.cc/xCjY1RdG/write.png"></img></div>
